...
class JD(object):
    ...
    def __init__(self, step, is_headless, down_img_count, img_dir="./images/jd/"):
        ...
        self.dr = webdriver.Chrome(
            "./chromedriver_win32/chromedriver")  # "/Users/mac/dong/json_add/JDCaptchaCrack/chromedriver_win32/chromedriver"
...
if __name__ == '__main__':
    ...
    jd.autologin("https://passport.jd.com/new/login.aspx", name, pw)
